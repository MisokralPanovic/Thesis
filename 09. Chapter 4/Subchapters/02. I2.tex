...
In conclusion we have observed differential human and bovine exogenously expressed IFIT2 with human and bovine IBs in co-infected/transfected cells. We have observed 

hi2f+hrsv - diff, incl, col+ex, ex, col+ex+s, col, ex+s (>0.5 only diff, each progresively larger median)
bi2f+hrsv - 2/3 excl (whole range) 1/6 diff 1/6 coloc + excl (both size separated)
bi2f+brsv - mainly exclusion with small diff in small ibs (but small dataset)
...
what is the driver of interaction might be dsRNA binding
