...
Taking all the accumulated IFIT2 data together we can conclude that it consistently interacts with both RSV IBs and pIBs, however, the precise mechanism of this interaction remains to be elucitated. Since ... coloc could mean rna

 ... it seems that the interaction (incl and coloc+excl) is consistent so we should investigate why ... possibl mechanisms ... dsRNA recognitions ... citation for these
