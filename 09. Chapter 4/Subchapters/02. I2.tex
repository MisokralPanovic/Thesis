...
summary of both so far

say that difficult to determine whata the crack so we need to detect ifit2 based on tag

that we can assess the oe with pIBs as it is easier than infection/transfection

that we can probe the oe using i2a i2b and flag antibodies to see what each of the antibodies see and then to get the grounmd truth
