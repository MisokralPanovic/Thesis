...
\begin{figure}
    ...
    \label{fig:Quantification Of Expression Changes of Human IFITs in A549 Cells Subjected to hIFN\(\alpha\) or hRSV.}
\end{figure}
...
\begin{figure}
    ...
    \label{fig:The Changes in Subcellular Localisation of Bovine IFITs in MDBK Cells Subjected to bIFN\(\alpha\) or bRSV}
\end{figure}
