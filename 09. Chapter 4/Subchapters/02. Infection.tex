...
\begin{figure}[h]
    ...
    \includegraphics[width=0.9\linewidth, height=6cm]{09. Chapter 4/Figs/test-bar.pdf} 
    \caption{test bar}
    \label{fig:subim1}
    \end{subfigure}
    \begin{subfigure}{0.5\textwidth}
    \includegraphics[width=0.9\linewidth, height=6cm]{09. Chapter 4/Figs/test-violin.pdf}
    \caption{test violin}
    \label{fig:subim2}
    \end{subfigure}
