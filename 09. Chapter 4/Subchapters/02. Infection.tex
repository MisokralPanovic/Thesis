...
\begin{figure}
    ...
    \caption{Caption for this figure with two images Caption for this figure with two images Caption for this figure with two images Caption for this figure with two images Caption for this figure with two images Caption for this figure with two images }
    \label{fig:image2}
\end{figure}
...
\begin{figure}
    ...
    \begin{subfigure}{0.5\textwidth}
    \includegraphics[width=1\linewidth]{09. Chapter 4/Figs/test-violin-width1.pdf} 
    \caption{test bar}
    \label{fig:subim1}
    \end{subfigure}
    \begin{subfigure}{0.5\textwidth}
    \includegraphics[width=1\linewidth]{09. Chapter 4/Figs/test-violin-width2.pdf}
    \caption{test violin}
    \label{fig:subim2}
    \end{subfigure}
