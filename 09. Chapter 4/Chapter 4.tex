...
aim to pib - oe in infection
same with 2 but also oe to decipher the differential antibody staining
...
\begin{figure}
    ...
    \end{subfigure}
    \caption[The Distributions of IB Areas Observed in co-Infected/Transfected Cells Per Exogenously Expressed IFIT Per RSV.]{\textbf{The Distributions of IB Areas Observed in co-Infected/Transfected Cells Per Exogenously Expressed IFIT Per RSV.} The distributions of human (panel a), and bovine (panel b) RSV IB areas in \(\mu \mbox{m}^2\) per exogenously expressed IFIT are shown.}
    \label{fig:The Distributions of IB Areas Observed in co-Infected/Transfected Cells Per Exogenously Expressed IFIT Per RSV}
\end{figure}
