\chapter{Introducion}
\section{Interferon-Induced Proteins with Tetratricopeptide Repeats} \label{Interferon-Induced Proteins with Tetratricopeptide Repeats}
...
\begin{figure}
    ...
    \label{Pathways Inducing ISG mRNA Production.}
\end{figure}
...
\begin{figure}
    ...
    \label{Overview of 5'RNA Modifications.}
\end{figure}




\subsection{Structural Features of IFIT Proteins} \label{Structural Features of IFIT Proteins}
...
\begin{figure}
    ...
    \label{IFIT Structures and Multimer Formation.}
\end{figure}




\subsection{Functions of IFIT Proteins} \label{Functions of IFIT Proteins}
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{04. Introduction//Figs/IFIT Mechanism of Action.png}
    ...
    \label{Overview of IFIT Mechanisms of Action}
\end{figure}




\subsection{IFIT During Cancer and Sepsis} \label{IFIT During Cancer and Sepsis}
...
\subsection{IFIT Responses to Viral Infections} \label{IFIT Responses to Viral Infections}
...
\subsection{Comparison between human and bovine} \label{Comparison between human and bovine}
...
\section{Respiratory Syncytial Virus} \label{Respiratory Syncytial Virus}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{04. Introduction//Figs/N_p_l_m21-interaction-overview.png}
...
\subsection{RSV Inclusion Bodies} \label{RSV Inclusion Bodies}
...
\subsection{Bovine vs Human Comparison} \label{Bovine vs Human Comparison}
asdfasdf




\section{Aims of the Study} \label{Aims}
