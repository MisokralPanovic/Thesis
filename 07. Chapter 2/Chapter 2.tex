...
from literature we know that human ifits are negative regulators of rsv infection. from chapter 1 we know that they are induced during infection and thus their potential action is relevant.

there is none information on bifit action on brav or hrsv in terms of viral fitnes

thinkig everything is the same, we will first look at similarity between human and bovine ifits

develop new qpcr technologies and new growth curves

repeat the study from chapter 1

validate data with rnaseq dataset analysis
...
\subsection{Similarity Between Human and Bovine IFITs} \label{subsec:Similarity Between Human and Bovine IFITs}
write about genomic regulation linking chapter 1
write about protein sequence and looking at alphafold
...
\subsection{RNA-Seq Analysis} \label{subsec:RNA-Seq Analysis}
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{07. Chapter 2/Figs/03. Bioinformatics Analysis/01. rnaseq volcano.png}
...
\subsection{Meta-Analysis} \label{subsec:Meta-Analysis bifit}
